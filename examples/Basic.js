...
var _binary_koan$elm_spruce$Spruce_Server$startListening = _elm_lang$core$Native_Platform.outgoingPort(
	'startListening',
	function (v) {
		return v;
	});
var _binary_koan$elm_spruce$Spruce_Server$initialState = F2(
	function (address, middleware) {
		return {
			ctor: '_Tuple2',
			_0: {},
			_1: _binary_koan$elm_spruce$Spruce_Server$startListening(address)
		};
	});
var _binary_koan$elm_spruce$Spruce_Server$onRequest = _elm_lang$core$Native_Platform.incomingPort(
	'onRequest',
...
var _binary_koan$elm_spruce$Basic$main = A2(
	...
	'localhost:4000',
	{ctor: '[]'})();
var _binary_koan$elm_spruce$Basic$listen2 = _elm_lang$core$Native_Platform.outgoingPort(
	'listen2',
	function (v) {
		return v;
	});
var _binary_koan$elm_spruce$Basic$onRequest = _elm_lang$core$Native_Platform.incomingPort('onRequest', _elm_lang$core$Json_Decode$string);
